...
const Login = () => {
    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <Card className="w-1/3 rounded-xl border bg-card text-card-foreground shadow py-12 ">
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(data => console.log(data))} className="space-y-4">
                            ...
                            <div className="mt-4 text-start">
                                <span className="text-gray-600 underline hover:text-black cursor-pointer">
                                    Esqueceu a senha?
                                </span>
                            </div>
                        </form>

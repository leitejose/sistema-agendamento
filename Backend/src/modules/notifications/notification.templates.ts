      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto;">
        <div style="text-align: center;">
          <div style="padding: 20px 0;">
            <img src="https://github.com/leitejose/sistema-agendamento/raw/main/Frontend/public/LogoMM.png" alt="Logo da Clínica" style="height: 60px;" />
          </div>
          ...
          <div style="margin: 10px 0;">
            <a href="https://www.google.com/maps?q=Av.+Calouste+Gulbenkian,+nº+4,+Coimbra" target="_blank">
              <img src="https://drive.google.com/uc?export=view&id=1wdBcCV-HodUmMQ_EbZPyicgFNmOeQPv6
"
